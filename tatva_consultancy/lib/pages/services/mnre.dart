...
class Mnre extends StatefulWidget {
  const Mnre({super.key});

  @override
  State<Mnre> createState() => _MnreState();
}

class _MnreState extends State<Mnre> {
  @override
